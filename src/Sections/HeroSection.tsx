...
const HeroSection = forwardRef<HTMLElement, object>((_, ref: ForwardedRef<HTMLElement>) => {
    return (
                ...
                <div className="flex flex-col items-center gap-4 text-center max-w-[600px] space-y-2">
                    <div className="space-y-2">
                        ...
                        <TypewriterEffect
                            ...
                            words={[
                                { text: "Desiging", className: "text-xs md:text-2xl font-medium" },
                                { text: "/Developer", className: " text-xs md:text-2xl font-medium" }
                            ]}
                        />
                    </div>
                    <p className="text-xs md:text-lg leading-tight">
                        Hey there! I&apos;m Aditya — a web developer driven by curiosity and creativity. I specialize in building modern web applications using tools like React, TypeScript, and Node.js. Let&apos;s turn ideas into something amazing.
                    </p>
                    <div className="flex items-center justify-around w-full max-w-[350px]">
                        <button className="btn btn-md lg:btn-lg rounded-full hover:shadow-lg bg-black text-white ring-0 border-0 shadow-[#3778C2] hover:text-[#3778C2]">
                            Resume
                        </button>
                        <Link href="#project" className="btn btn-md lg:btn-lg rounded-full bg-white text-black ring-0 border-0 hover:shadow-lg shadow-[#3778C2]">
                            My Work
                        </Link>
                    </div>
                </div>
